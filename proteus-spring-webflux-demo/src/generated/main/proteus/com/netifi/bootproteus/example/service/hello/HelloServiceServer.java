...
public final class HelloServiceServer extends io.netifi.proteus.AbstractProteusService {
  ...
  public HelloServiceServer(HelloService service, io.micrometer.core.instrument.MeterRegistry registry) {
    this.service = service;
    this.getHello = io.netifi.proteus.metrics.ProteusMetrics.timed(registry, "proteus.server", "namespace", "com.netifi.bootproteus.example.service.hello", "service", "HelloService", "method", "getHello");
  }
  ...
  public reactor.core.publisher.Mono<io.rsocket.Payload> requestResponse(io.rsocket.Payload payload) {
    try {
      ...
      switch(io.netifi.proteus.frames.ProteusMetadata.methodId(metadata)) {
        case HelloService.METHOD_GET_HELLO: {
          com.google.protobuf.CodedInputStream is = com.google.protobuf.CodedInputStream.newInstance(payload.getData());
          return service.getHello(com.netifi.bootproteus.example.service.hello.HelloRequest.parseFrom(is), metadata).map(serializer).transform(getHello);
        }
        default: {
