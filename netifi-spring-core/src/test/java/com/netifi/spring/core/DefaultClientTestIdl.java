...
public class DefaultClientTestIdl implements TestIdl {
    ...
    public DefaultClientTestIdl(io.rsocket.RSocket rSocket, io.micrometer.core.instrument.MeterRegistry registry) {
    }
    ...
    public DefaultClientTestIdl(io.rsocket.RSocket rSocket, io.micrometer.core.instrument.MeterRegistry registry, io.opentracing.Tracer tracer) {
    }
}
