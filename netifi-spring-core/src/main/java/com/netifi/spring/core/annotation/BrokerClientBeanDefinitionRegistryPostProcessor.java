...
public class BrokerClientBeanDefinitionRegistryPostProcessor
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(
        BrokerClientBeanDefinitionRegistryPostProcessor.class);
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        beanFactory.setAutowireCandidateResolver(new ContextAnnotationAutowireCandidateResolver() {
            ...
            public Object getSuggestedValue(DependencyDescriptor descriptor) {
                BrokerClient annotation = descriptor.getField() == null
                    ? AnnotatedElementUtils.getMergedAnnotation(descriptor.getMethodParameter().getParameter(), BrokerClient.class)
                    : AnnotatedElementUtils.getMergedAnnotation(descriptor.getAnnotatedElement(), BrokerClient.class);
