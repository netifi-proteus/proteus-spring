...
public class ScanClassPathBeanDefinitionRegistryPostProcessor implements
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry)
        ...
        String[] componentScanAnnotatedBeanNames = beanFactory.getBeanNamesForAnnotation(
                ComponentScan.class);
        ...
        for (String beanName : componentScanAnnotatedBeanNames) {
            ...
            Map<String, Object> attributes = definition.getMetadata()
        ...
        ClassPathBeanDefinitionScanner
                scanner = new ClassPathBeanDefinitionScanner(beanFactory, false);
