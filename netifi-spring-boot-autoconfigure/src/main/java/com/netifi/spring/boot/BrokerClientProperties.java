...
/**
 * Netifi Broker Client configuration options that can be set via the application
...
public class BrokerClientProperties {
    ...
    public static final class MetricsProperties {
        ...
        @NotNull
        @NotEmpty
        private String group = "com.netifi.metrics";
    ...
    public static final class TracingProperties {
        ...
        @NotNull
        @NotEmpty
        private String group = "com.netifi.tracing";
