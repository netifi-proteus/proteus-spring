...
public final class VowelCountServiceClient implements VowelCountService {
  ...
  public reactor.core.publisher.Flux<com.netifi.proteus.demo.vowelcount.service.VowelCountResponse> countVowels(org.reactivestreams.Publisher<com.netifi.proteus.demo.vowelcount.service.VowelCountRequest> messages) {
    return countVowels(messages, io.netty.buffer.Unpooled.EMPTY_BUFFER);
  }

  @java.lang.Override
  public reactor.core.publisher.Flux<com.netifi.proteus.demo.vowelcount.service.VowelCountResponse> countVowels(org.reactivestreams.Publisher<com.netifi.proteus.demo.vowelcount.service.VowelCountRequest> messages, io.netty.buffer.ByteBuf metadata) {
    return rSocket.requestChannel(reactor.core.publisher.Flux.from(messages).map(
      ...
      })).map(deserializer(com.netifi.proteus.demo.vowelcount.service.VowelCountResponse.parser())).transform(countVowels);
  }
