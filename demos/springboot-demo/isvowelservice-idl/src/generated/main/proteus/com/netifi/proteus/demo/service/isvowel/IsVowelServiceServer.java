...
public final class IsVowelServiceServer extends io.netifi.proteus.AbstractProteusService {
  ...
  public IsVowelServiceServer(IsVowelService service, io.micrometer.core.instrument.MeterRegistry registry) {
    this.service = service;
    this.isVowel = io.netifi.proteus.metrics.ProteusMetrics.timed(registry, "proteus.server", "namespace", "com.netifi.proteus.demo.service.isvowel", "service", "IsVowelService", "method", "isVowel");
  }

  @java.lang.Override
  public int getNamespaceId() {
    return IsVowelService.NAMESPACE_ID;
  }
    ...
    try {
      ...
      switch(io.netifi.proteus.frames.ProteusMetadata.methodId(metadata)) {
        case IsVowelService.METHOD_IS_VOWEL: {
          ...
          return service.isVowel(com.netifi.proteus.demo.service.isvowel.IsVowelRequest.parseFrom(is), metadata).map(serializer).transform(isVowel);
        }
        default: {
