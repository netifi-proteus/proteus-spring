...
public final class IsVowelServiceClient implements IsVowelService {
  ...
  public reactor.core.publisher.Mono<com.netifi.proteus.demo.isvowel.service.IsVowelResponse> isVowel(com.netifi.proteus.demo.isvowel.service.IsVowelRequest message) {
    return isVowel(message, io.netty.buffer.Unpooled.EMPTY_BUFFER);
  }

  @java.lang.Override
  public reactor.core.publisher.Mono<com.netifi.proteus.demo.isvowel.service.IsVowelResponse> isVowel(com.netifi.proteus.demo.isvowel.service.IsVowelRequest message, io.netty.buffer.ByteBuf metadata) {
    ...
    }).map(deserializer(com.netifi.proteus.demo.isvowel.service.IsVowelResponse.parser())).transform(isVowel);
  }
